...
|------------------------|-------------|---------|
| Phân tích requirement, extract AC | [`.claude/commands/analyze_requirement_document.md`](.claude/commands/analyze_requirement_document.md) | |
