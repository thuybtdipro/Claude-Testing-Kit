...
4b. **Sinh UI Visual TCs** theo Bảng Field-Level Visual States Validation trong skill:
   - 1 TC screen level "Verify UI tổng thể" — đặt ĐẦU bảng TC
   - Visual state TCs per field (6 states: Normal, Focus, Filled, Error, Disabled, Loading) — đặt TRƯỚC logic TCs của cùng field
