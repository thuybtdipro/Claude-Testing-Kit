...
> - **Skill:** `.claude/skills/requirements_analyzer/SKILL.md` — Phân tích requirements
...
|------|-------------|-------------|
| **DOCUMENT** (mặc định) | User cung cấp tài liệu/spec mô tả modules + business rules | File `.md`, `.doc`, link Google Drive/Docs/Figma, hoặc mô tả text |
...
| **Tài liệu yêu cầu** (DOCUMENT mode) | ✅ | File `.md`, link Google Drive/Docs/Figma, user story, hoặc text mô tả |
