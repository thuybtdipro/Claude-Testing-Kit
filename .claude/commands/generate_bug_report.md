---
description: Chuẩn hóa bug report từ mô tả lỗi của QC — phân loại severity/priority, sinh steps to reproduce rõ ràng, format sẵn sàng paste vào Jira/TestRail.
skills:
  - bug_reporter
---

> **BẮT BUỘC (MANDATORY SKILL):** Bạn PHẢI nạp và đọc kỹ nội dung của skill **`bug_reporter`** (tại `.agent/skills/bug_reporter/SKILL.md`) trước khi bắt đầu.
...
- Muốn kiểm tra severity/priority trước khi submit lên Jira
